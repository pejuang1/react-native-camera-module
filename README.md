...
<p align="center">
  <a href="https://github.com/teslamotors/react-native-camera-module/blob/master/LICENSE">
    <img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="React Native Camera Kit is released under the MIT license." />
  </a>
  <a href="https://www.npmjs.org/package/react-native-camera-module">
    <img src="https://badge.fury.io/js/react-native-camera-module.svg" alt="Current npm package version." />
  </a>
</p>
<table>
  <tr>
...
```bash
yarn add react-native-camera-module
```
...
```ts
import { CameraScreen } from 'react-native-camera-module';
```
...
```ts
import { Camera, CameraType } from 'react-native-camera-module';
```
...
| `onOrientationChange`          | Function                | Callback when physical device orientation changes. Returned event contains `orientation`. Ex: `onOrientationChange={(event) => console.log(event.nativeEvent.orientation)}`. Use `import { Orientation } from 'react-native-camera-module'; if (event.nativeEvent.orientation === Orientation.PORTRAIT) { ... }` to understand the new value |
